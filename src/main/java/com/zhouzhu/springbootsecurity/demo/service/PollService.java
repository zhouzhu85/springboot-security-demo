...
import com.zhouzhu.springbootsecurity.demo.exception.BadRequestException;
import com.zhouzhu.springbootsecurity.demo.exception.ResourceNotFoundException;
import com.zhouzhu.springbootsecurity.demo.payload.PagedResponse;
import com.zhouzhu.springbootsecurity.demo.payload.PollRequest;
import com.zhouzhu.springbootsecurity.demo.payload.PollResponse;
import com.zhouzhu.springbootsecurity.demo.payload.VoteRequest;
import com.zhouzhu.springbootsecurity.demo.pojo.*;
...
import com.zhouzhu.springbootsecurity.demo.util.ModelMapper;
...
public class PollService {
    ...
    private Map<Long, User> getPollCreatorMap(List<Poll> polls) {
        ...
        Map<Long, User> createMap = creators.stream().collect(Collectors.toMap(User::getId, Function.identity()));
        return createMap;
    }
    ...
    private Map<Long, Long> getChoiceVoteCountMap(List<Long> pollIds) {
        ...
        Map<Long, Long> choiceVoteMap = votes.stream().collect(Collectors.toMap(ChoiceVoteCount::getChoiceId, ChoiceVoteCount::getVoteCount));
